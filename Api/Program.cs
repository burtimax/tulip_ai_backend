...
using ModulePlantId.Extensions;
using ModuleS3.Extensions;
using NSwag;
...
services.AddS3ObjectStorage(builder.Configuration);
services.AddModuleLLM(builder.Configuration);
services.AddModulePlantId(builder.Configuration);
services.AddCors();
services.AddMapster();
